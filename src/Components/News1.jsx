...
const News =(props)=> {
  ...
  useEffect(() => {
    document.title = `${props.category === 'general'? 'Home'
          : capitalizeFirstLetter(props.category)} - HindExpress: Unveiling India's Stories, Swift and Clear `;
    updateNews();
  ...
  const fetchMoreData = async () => {
    ...
    return (
      <>
        <h2 className='text-center'style={{marginTop: '90px'}}>{props.category==='general'? 'Top' : capitalizeFirstLetter(props.category)} Headlines</h2>
